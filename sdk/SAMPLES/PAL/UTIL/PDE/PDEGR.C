...

{
    ...
    WinText(pWin, x,y+50, " -----|-------------|--------------|---------- ");
    WinText(pWin, x,y+60, "  UP  |  move UP    | smooth UP    | depth (-) ");
    WinText(pWin, x,y+70, " DOWN |  move DOWN  | smooth DOWN  | depth (+) ");
    ...
    WinText(pWin, x,y+110," In most cases the F9 and ESC keys are used to ");
    WinText(pWin, x,y+120," cancel an operation, F10 & ENTER to accept it.");
...
void ItemHandler(DIAGDEF *pDialog)
{
   ...
   switch(type) {
      ...
      case BITMAP:
         x1=100; y1=50; x2=160; y2=100; step=1; break;
